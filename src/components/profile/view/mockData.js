...
export const profileData = {
    ...
    accepted_cryptos: [
        { slug: 'bitcoin-testnet', name: 'BTC', icon: '/icons/btc.png', contract: "0xfakeBtcContractAddress", blockchain: "Bitcoin Testnet", transferContract: "0xf0ED7a3Bcde90242d2C3318A299C8E214d8018f0" }   ,
